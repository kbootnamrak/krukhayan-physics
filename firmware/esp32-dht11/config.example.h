...
// LED บนบอร์ด ESP32 DevKit ส่วนใหญ่อยู่ที่ GPIO2 แต่บอร์ดทรงเล็กบางรุ่นไม่มี LED ดวงนี้
// ถ้าไม่มี ไฟสถานะก็แค่ไม่ติด โปรแกรมยังทำงานปกติทุกอย่าง — ดูสถานะทาง Serial Monitor แทนได้
